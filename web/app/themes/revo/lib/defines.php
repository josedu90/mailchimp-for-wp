	...
	$options[] = array(
		...
		'fields' => array(
			array(
				'id' => 'info_typo1',
				'type' => 'info',
				'title' => esc_html( 'Product Categories Config', 'revo' ),
				'desc' => '',
				'class' => 'revo-opt-info'
				),
			...
			array(
				'id' => 'info_typo1',
				'type' => 'info',
				'title' => esc_html( 'Product General Config', 'revo' ),
				'desc' => '',
				'class' => 'revo-opt-info'
				),
			...
			array(
				'id' => 'info_typo1',
				'type' => 'info',
				'title' => esc_html( 'Product Single Config', 'revo' ),
				'desc' => '',
				'class' => 'revo-opt-info'
				),
			...
			array(
				'id' => 'info_typo1',
				'type' => 'info',
				'title' => esc_html( 'Config For Product Categories Widget', 'revo' ),
				'desc' => '',
				'class' => 'revo-opt-info'
				),
	...
	$options[] = array(
			...
			'fields' => array(
				array(
					'id' => 'info_typo1',
					'type' => 'info',
					'title' => esc_html( 'Global Typography', 'revo' ),
					'desc' => '',
					'class' => 'revo-opt-info'
				),
				...
				array(
					'id' => 'info_typo2',
					'type' => 'info',
					'title' => esc_html( 'Header Tag Typography', 'revo' ),
					'desc' => '',
					'class' => 'revo-opt-info'
				),
				...
				array(
					'id' => 'info_typo2',
					'type' => 'info',
					'title' => esc_html( 'Main Menu Typography', 'revo' ),
					'desc' => '',
					'class' => 'revo-opt-info'
				),
				...
				array(
					'id' => 'info_typo2',
					'type' => 'info',
					'title' => esc_html( 'Custom Typography', 'revo' ),
					'desc' => '',
					'class' => 'revo-opt-info'
				),
