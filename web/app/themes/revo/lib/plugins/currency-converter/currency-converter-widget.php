...
class WooCommerce_Widget_Currency_Converter extends WP_Widget {
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'currency_codes' ) ); ?>"><?php esc_html_e( 'Currency codes:', 'revo' ); ?> <small>(<?php esc_html_e( '1 per line', 'revo' ) ?>)</small></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'currency_display' ) ); ?>"><?php esc_html_e( 'Currency Display Mode:', 'revo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'message' ) ); ?>"><?php esc_html_e( 'Widget message:', 'revo' ) ?></label>
			<textarea class="widefat" rows="5" cols="20" name="<?php echo esc_attr( $this->get_field_name( 'message' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'message' ) ); ?>"><?php if ( isset ( $instance['message'] ) ) echo esc_attr( $instance['message'] ); else esc_html_e( "Currency conversions are estimated and should be used for informational purposes only.", 'revo' ); ?></textarea>
		</p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'show_symbols' ) ); ?>"><?php esc_html_e( 'Show currency symbols in widget:', 'revo' ) ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'show_reset' ) ); ?>"><?php esc_html_e( 'Show reset link:', 'revo' ) ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'disable_location' ) ); ?>"><?php esc_html_e( 'Disable location detection:', 'revo' ) ?></label>
